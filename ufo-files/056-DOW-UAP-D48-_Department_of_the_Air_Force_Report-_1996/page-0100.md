...
generated_at: "2026-05-08T16:42:33.160636+00:00"
---

# DOW-UAP-D48, Department of the Air Force Report, 1996 - Page 100

$\bar{X}_n = \bar{X}_{n-1} (1-a_n) + x_n (a_n)$
$\bar{X}_n = \bar{X}_{n-1} + a_n (x_n - \bar{X}_{n-1})$
(12)

For the equally-weighted case, the recursive filter factor $a_n = 1/n$.
Using the same example, with $\bar{X}_o = 0$,

$\bar{X}_1 = x_1 = 6$
$\bar{X}_2 = \bar{X}_1 + \frac{1}{2}(x_2 - \bar{X}_1) = 6 + \frac{1}{2}(5-6) = 5.5$
$\bar{X}_3 = \bar{X}_2 + \frac{1}{3}(x_3 - \bar{X}_2) = 5.5 + \frac{1}{3}(7-5.5) = 6.0$
(13)
...
$\bar{X}_n = \frac{\sum_{i=1}^{n} i x_i}{\sum_{i=1}^{n} i}$
(14)

Using the same numerical example as before, where $x_1 = 6, x_2 = 5, \text{ and } x_3 = 7$,

$\bar{X} = \frac{1 \cdot 6 + 2 \cdot 5 + 3 \cdot 7}{1+2+3} = \frac{37}{6} = 6.17$
(15)
