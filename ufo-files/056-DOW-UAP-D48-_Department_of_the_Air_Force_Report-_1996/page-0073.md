...
| 0.001 | 270 | 12,000 * (new ps & TB) | 1,000 | 3.00 | 88.8 |
...
As in the case of Atlas, Table 23 again shows that the risks in the launch area are highly dependent on qa and thus on A, but relatively insensitive to changes in B if a proper value is selected for A. For example, if qa = 10,000, the computed risks for B = 1,000 (A = 3.10) and B = 2,000 (A = 3.35) differ by less than 3%. For the no-breakup cases where B = 1,000 and then 10,000, the computed risks in the launch area differ by less than 2%.
